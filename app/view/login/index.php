        ...
        <div class="col-lg-5 col-md-7">
            ...
            <div class="card-header bg-transparent pb-2 ">
              ...
              <form role="form" action="<?= BASEURL ?>login/verify/user" method="POST">
                ...
                <div class="container mt-4">
                  <div class="row">
                    <div class="col-6">
                      <img src="../public/img/captcha/captcha1.jpg" class='w-75 h-75'>
                    </div>
                    <div class="col-6">
                      <input type="text" class="form-control" name="result" placeholder="isi captcha">
                    </div>
                  </div>
                </div>
          ...
          <div class="row mt-2">
            ...
            <div class="col-6 text-right">
              <a href="<?= BASEURL; ?>help" class="text-muted"><small>Bantuan</small></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
            <p>Masukkan email terkait untuk kami kirimkan password baru, mohon tunggu 1x24 jam untuk konfirmasi di email yang akan dikirimkan oleh tim kami.</p>
          </div>
          <form action="<?= BASEURL ?>login/forgetPassword" method="POST">
            <div class="form-group">
              <label for="emailforget">Email</label>
              <input type="email" class="form-control" id="email_forget" placeholder="email" name="email_forget" required>
            </div>
