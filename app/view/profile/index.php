...
<div id="div-header">
  ...
  <?php if ($data['edit'] === true) { ?>
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(<?= PATHFOTO . $data['profil']['profilfoto'] ?>);
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-10">
            <?php if ($data['edit'] === true) {
              echo "<h1 class='display-2 text-white'>Halo!</h1>";
            } else {
            } ?>

            <h1 class="display-3 text-white"><?= $data['profil']['name'] ?></h1>
          ...
          <div class="col-lg-8 col-md-10"><?php Alert::showMessage(); ?></div>
        </div>
      </div>
      </div>
    </div>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2 ">
                <div id="eventphoto" class="card-profile-image">
                  ...
                  <?php if ($data['edit'] === true) { ?>
                    <?php if (!file_exists(PATHFOTO . $data['profil']['profilfoto'])) {
                      if ($data['profil']['gender'] === "Laki-Laki") { ?>
                        <img id="changeimg" src="<?= PATHFOTO . "man.svg" ?>" class="rounded-circle" width="100px">
                      <?php } else { ?>
                        <img id="changeimg" src="<?= PATHFOTO . "girl.svg" ?>" class="rounded-circle" width="100px">
                      <?php } ?>
                    ...
                    <div id="changephoto" class=" d-flex justify-content-center" style="opacity:0">
                      <button id="btn-photo" class="btn btn-sm btn-default text-center mt-3 mx-auto" data-toggle="modal" data-target="#alertupdate">Change Photo</button>
                      <button id="btn-photodisable" class="btn btn-sm btn-default text-center mt-3 mx-auto" style="display: none">Change Photo</button>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-name1">Nama</label>
                  ...
                  <div id="uploadfile" class="row" style="display:none">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input_rapot" name="raport" class="form-control form-control-alternative" type="file">
                        <br>
